        ...
        <div class="row mt-1 mb-1">
            ...
            <div class="offset-lg-1 col-12 col-lg-3 align-self-start mt-2">
                ...
                if (isset($_SESSION["user"])) {
                    ...
                    <span class="text-lg-start-text-success"><b>Hi</b>
                        <?php echo $data["fname"]; ?>
                    </span> |
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" href="#" onclick="contactAdmin();">
                                    Contact Admin
                                </a>
                            </li>
                        </ul>
                    ...
                    <!-- msg modal -->
                    <div class="modal" tabindex="-1" id="contact-admin">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-3 d-grid">
                                                <button type="button" class="btn btn-primary" onclick="sendAdminMsg();">
                                                    Send
                                                </button>
                                            </div>
                                        </div>
