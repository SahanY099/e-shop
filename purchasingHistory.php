                ...
                if ($invoice_num == 0) {
                    ...
                    <div class="col-12">
                        <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bg-info text-center text-lg-start">
                                            <label class="form-label text-white fs-6 py-5">
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                <span class="badge text-bg-warning">Waiting to accept</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button onclick="addFeedback(<?php echo $invoice_data['product_id']; ?>)"
                            ...
                            <!-- model -->
                            <div class="modal" tabindex="-1" id="feedback-modal-<?php echo $invoice_data['product_id']; ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9">
                                                                <textarea class="form-control" cols="50" rows="8" id="feed">
                                                                                                                                                        </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button onclick="saveFeedback(<?php echo $invoice_data['product_id']; ?>)"
