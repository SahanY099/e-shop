                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="input-group mt-3 mb-3">
                            ...
                            <select class="form-select" style="max-width: 250px;" id="basic-search-select">
                                ...
                                $category_rs = Database::search($category_q);
                            ...
                            <div id="carouselExampleIndicators" class="offset-2 col-8 carousel slide"
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="resources/slider_images/posterimg.jpg" alt="Carousel Image 01"
                                    ...
                                    <div class="carousel-item">
                                        <img src="resources/slider_images/posterimg2.jpg" alt="Carousel Image 02"
                                            class="d-block img-thumbnail poster-img-1" />
                                    </div>
                                    <div class="carousel-item">
                                        <img src="resources/slider_images/posterimg3.jpg" alt="Carousel Image 03"
                                            class="d-block img-thumbnail poster-img-1" />
                            ...
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        FROM `product`
                                        WHERE
                                            `category_cat_id` = '" . $category_data["cat_id"] . "' AND
                                            `status_status_id` = '1'
