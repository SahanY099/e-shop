                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check form-check-inline mx-5">
                                                        <input id="brand-new" type="radio" name="c" checked
                                                            class="form-check-input" />
                                                        <label class="form-check-label fw-bold" for="brand-new">Brand
                                                            new</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" id="used" type="radio" name="c" />
