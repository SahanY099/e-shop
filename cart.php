                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        &nbsp;
                                                        <input type="number"
                                                            class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cart-qty-text"
                                                            value="<?php echo $cart_data["qty"]; ?>"
                                                            onchange="changeCartQty(<?php echo $cart_data['cart_id']; ?>);"
                                                            id="qty-num-<?php echo $cart_data['cart_id']; ?>">
                                                        <br><br>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card-body d-grid">
                                                        ...
                                                        <a class="btn btn-outline-danger mb-2"
                                                            onclick="deleteFromCart(<?php echo $cart_data['cart_id']; ?>);">
                                                            Remove
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        <div class="col-6 col-md-6">
                                                            <span class="fw-bold fs-5 text-black-50">
                                                                Requested Total
                                                        ...
                                                        <div class="col-6 col-md-6 text-end">
                                                            <span class="fw-bold fs-5 text-black-50">
                                                                Rs.
                                                                <?php echo ($product_data["price"] * $cart_data["qty"]) + $ship; ?>.00
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
